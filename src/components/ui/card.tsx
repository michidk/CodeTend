...
function CardTitle({
  ...
  return (
    <Comp
      ...
      className={cn(
        'font-display text-lg leading-snug font-bold tracking-tight group-data-[size=sm]/card:text-base',
        className,
      )}
      {...props}
    />
