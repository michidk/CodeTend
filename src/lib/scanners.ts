...
Calibrate: findings from this discovery pass are security hypotheses that an independent agent will review for practical exploitability. Trace the strongest realistic attack path you can support, distinguish observed code from assumptions, and do not inflate severity to compensate for uncertainty. Reserve critical for exposures reachable today (a live secret in the repository, an unauthenticated destructive endpoint) and high for insecure defaults that will bite on the first real deployment.`,
  },
]
